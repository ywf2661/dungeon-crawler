...
*/
  ...
  function originStories(){
    ...
    return {
      gold: [
        ...
        {text:'"...상관없다. 살아서 나가겠다. 그리고 반드시, 손에 쥐고 나가겠다."', title:who},
      ...
      truth: [
        ...
        {text:'"그렇다면 더더욱 알아야겠소. 감춰진 것일수록, 감춰진 이유가 있는 법이니."', title:who},
      ...
      survival: [
        ...
        {text:'"세지 않아도 좋다. 나는 살아서 나갈 테니까."', title:who},
  ...
  function renderOriginStep(step){
    ...
    if(step==='q1' || step==='q2'){
      ...
      const lines = stories[originAnswers.q1] || stories.survival;
