...
*/
  ...
  /* ============ 난이도 ============
     ...
     보통: 클리어(엔딩) 기록이 하나라도 있으면 해금. 도망 대신 굴복만 가능(사용자
           요청으로 변경), 몬스터가 소폭 강화.
     하드코어: "보통" 난이도로 클리어한 기록이 있으면 해금. 도망 대신 굴복만
               가능, 몬스터가 더 강화되고 사망 시 마을로 돌아가는 대신 레벨
               1·1층부터 다시 시작한다. 대신 유물 슬롯을 4개까지 지닐 수 있다. */
  const DIFFICULTIES = [
    {id:'easy',     name:'쉬움',     desc:'회랑에 첫발을 들이는 이들을 위한 길.'},
    {id:'normal',   name:'보통',     desc:'문은 닫혔다 — 남은 건 나아가거나, 무릎 꿇는 것뿐.'},
    {id:'hardcore', name:'하드코어', desc:'회랑은 두 번째 기회를 주지 않는다.'},
  ];
