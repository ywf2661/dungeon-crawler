...
*/
  ...
  const SKILLDB = {
    ...
    // 때려준다는 그림.
    rogueShadowStrike: {name:'환영 은신', mp:8, desc:'그림자 속으로 완전히 숨어든다. 2턴간 받는 피해가 크게 줄어들고, 동시에 분신이 예약되어 적의 턴이 오기 직전 자동으로 한 번 공격한다',
      type:'defbuff', turns:2, mult:0.35, armsAfterimage:true},
