...
*/
  ...
  const MONSTERS = [
    ...
    {type:'knight',  name:'짓눌린 맹세',   minDepth:8,  hp:52, atk:13, def:8,  spd:5,  exp:36, gold:[20,34], skills:['smash'],
      dex:'무릎 꿇은 자세 그대로 굳어버린 기사. 지키겠다던 맹세만은 아직 놓지 못한 듯하다.'},
  ...
  const LOCATIONS = [
    ...
    {max:9999, name:'회랑의 심장부', desc:'차갑고 무거운 공기가 짓누른다. 이 회랑의 가장 깊은 곳, 태초부터 있었던 무언가가 아직 잠들지 않았다. 차가운 공기 속에, 아주 오래전에 멈춰버린 무언가의 냄새가 희미하게 배어 있다.'},
  ];
